...
# command Handler
  @bot.message_handler(commands=['bp','bypass'])
    def bypass_command_handler(message):
...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    reply_markup=InlineKeyboardMarkup([
        [ InlineKeyboardButton("Channel", url="https://t.me/+BbTn2tr1KeViODA1")],
        [ InlineKeyboardButton("Owner", url="http://t.me/Eritsuu") ]]), 
